      ...
      <div className="relative px-4 py-4">
        ...
        <div className="mt-3 pt-3 border-t border-border-subtle space-y-2">
          ...
          {convertHint && (
            ...
            <div className="absolute bottom-3 left-4 right-4 flex items-start gap-2 px-3 py-2 text-[11px] text-warning-ink bg-bg-card border border-warning-ink/35 rounded-lg shadow-xl z-20">
