...
import { Copy, Trash2, Palette, Undo2, Redo2, LayoutGrid, Check, Type, ChevronUp, ChevronDown, ScanSearch, Plus, Mouse, Keyboard, ArrowUp, ArrowDown } from 'lucide-react';
...
export function Toolbar({ columnVisibility, onColumnVisibilityChange }: ToolbarProps) {
  ...
  useEffect(() => {
    if (!showColDropdown && !showAddActions) return;
  ...
  }, [showColDropdown, showAddActions]);
