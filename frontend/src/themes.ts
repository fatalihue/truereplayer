...
// Themes ordered by accent hue: neutral → pink → orange/yellow → green → cyan/blue → purple.
export const themes: ThemePreset[] = [
  ...
  },
  {
    id: 'neon',
    name: 'Neon',
    preview: ['#0a0e0a', '#111a11', '#182418', '#00ff66'],
    colors: {
      'bg-base': '#0a0e0a',
      'bg-surface': '#111a11',
      'bg-card': '#182418',
  ...
  {
    // Catppuccin Mocha — official catppuccin/catppuccin palette.
    // base #1e1e2e, mantle #181825, crust #11111b, text #cdd6f4, mauve #cba6f7.
    // Elevated uses an interpolation between surface0 and surface1 so the
    // "raised" panel doesn't feel jarringly bright next to surface0/card.
    id: 'catppuccin-mocha',
    ...
    colors: {
      ...
      'bg-elevated': '#3a3b50',
      'bg-input': '#11111b',
      'border-subtle': 'rgba(180,190,254,0.06)',
      'border-default': 'rgba(180,190,254,0.1)',
      'border-strong': 'rgba(180,190,254,0.15)',
      'text-primary': '#cdd6f4',
